...
public class BookingServiceImplTest {
    ...
    void testGetAllBookingsByBookerId() {
        ...
        List<BookingDto> sourceBookings = Stream.of(
                makeBookingDto(LocalDateTime.of(2023, 8, 29, 13, 0),
                        LocalDateTime.of(2023, 8, 30, 13, 0), itemDto1.getId()),
                makeBookingDto(LocalDateTime.of(2023, 8, 28, 13, 0),
                        LocalDateTime.of(2023, 8, 29, 13, 0), itemDto2.getId()),
                makeBookingDto(LocalDateTime.of(2023, 8, 27, 13, 0),
                        LocalDateTime.of(2023, 8, 28, 13, 0), itemDto3.getId())
